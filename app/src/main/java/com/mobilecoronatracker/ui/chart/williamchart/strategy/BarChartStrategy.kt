...
class BarChartStrategy : ChartContract.HorizontalAxisLabelsPlacingStrategy {
    override fun placeLabels(
        ...
        val halfBarWidth = (bounds.right - bounds.left) / labels.size / 2
        val labelsLeftPosition = bounds.left + halfBarWidth
        val labelsRightPosition = bounds.right - halfBarWidth
